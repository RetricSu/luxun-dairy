...
URL = "https://zh.wikisource.org/zh-hans/%E9%AD%AF%E8%BF%85%E6%97%A5%E8%A8%98/%E7%94%B2%E5%AF%85%E6%97%A5%E8%A8%98"
...
def scrape_luxun_diary():
    ...
    for heading in month_headings:
        ...
        for pre in pre_elements:
            ...
            # Create ISO date
            iso_date = f"1914-{month_num:02d}-{current_day:02d}"
            
            # Create raw date
            day_text = get_chinese_number(current_day) + "日"
            date_raw = f"一九一四年{month_name}{day_text}"
    ...
    for month, count in sorted(months_count.items(), key=lambda x: month_map.get(x[0].replace("一九一四年", ""), 0)):
...
def save_common_diary_json(items):
    ...
    os.makedirs("output_1914", exist_ok=True)
    
    # Save as a single JSON file
    output_file = "output_1914/luxun_jiayin_diary.json"
    ...
    individual_dir = "output_1914/individual_entries"
...
if __name__ == "__main__":
    print("Starting to scrape Lu Xun's 1914 diary...")
