  ...
  return (
    <div className="py-10 px-8 text-center">
      <div className="text-center mb-4">
        ...
        <h3 className="m-0 mb-3 text-2xl text-[#5f5347] dark:text-text-primary-dark font-medium">今日日记已完成！</h3>
        ...
        <p className="text-[#7c6d58] dark:text-text-secondary-dark text-lg m-0">您已记录下今天的思绪与感悟。</p>
      </div>
    </div>
  );
} 
